...
public class JunitTestStudent {
	...
	public static final String TEST_STUDENT_EMAIL = "angelacheng@csumb.edu";
	public static final String TEST_STUDENT_NAME  = "angela";
	...
	public void addNewStudent()  throws Exception {
		...
		//Do a http post request with body of studentDTO as JSON
		...
		//Verify the return status = OK (value 200) 
	...
	//Hold on Student Registration - TEST
	@Test
	public void placeHold() throws Exception {
		...
		//Do a http post request with param of student id
	...
	//Releasing a hold on Student Registration - TEST 
	//Same logic as placeHold 
	@Test
	public void removeHold() throws Exception {
		...
		//Stubs for database repositories that return test data and updated student
	    given(studentRepository.findById(TEST_STUDENT_ID)).willReturn(student);
		...
		//Verify return status = OK (value 200) 
		assertEquals(200, response.getStatus());
